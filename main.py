...
class TranslatePrograme():
    def __init__(self, root_window):
        ...
        self.all_langs = {'Afrikaans': 'af', 'Amharic': 'am', 'Arabic': 'ar', 'Azerbaijani': 'az', 'Belarusian': 'be', 'Bulgarian': 'bg', 'Bengali': 'bn', 'Bosnian': 'bs', 'Catalan': 'ca', 'Corsican': 'co', 'Welsh': 'cy', 'German': 'de', 'Ewe': 'ee', 'Spanish': 'es', 'Estonian': 'et', 'Finnish': 'fi', 'French': 'fr', 'Irish': 'ga', 'Scottish Gaelic': 'gd', 'Galician': 'gl', 'Gujarati': 'gu', 'Croatian': 'hr', 'Haitian': 'ht', 'Hungarian': 'hu', 'Indonesian': 'id', 'Icelandic': 'is', 'Italian': 'it', 'Central Khmer': 'km', 'Kannada': 'kn', 'Kirghiz': 'ky', 'Latin': 'la', 'Luxembourgish': 'lb', 'Lithuanian': 'lt', 'Latvian': 'lv', 'Malagasy': 'mg', 'Macedonian': 'mk', 'Malayalam': 'ml', 'Mongolian': 'mn', 'Marathi': 'mr', 'Malay (macrolanguage)': 'ms', 'Maltese': 'mt', 'Burmese': 'my', 'Nepali (macrolanguage)': 'ne', 'Dutch': 'nl', 'Norwegian': 'no', 'Panjabi': 'pa', 'Polish': 'pl', 'Pushto': 'ps', 'Portuguese': 'pt', 'Romanian': 'ro', 'Russian': 'ru', 'Sindhi': 'sd', 'Sinhala': 'si', 'Slovak': 'sk', 'Slovenian': 'sl', 'Samoan': 'sm', 'Shona': 'sn', 'Somali': 'so', 'Serbian': 'sr', 'Southern Sotho': 'st', 'Swedish': 'sv', 'Tajik': 'tg', 'Thai': 'th', 'Tagalog': 'tl', 'Turkish': 'tr', 'Uighur': 'ug', 'Uzbek': 'uz', 'Vietnamese': 'vi'}
